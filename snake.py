...
screen = pygame.display.set_mode([ai.screenx, ai.screeny])	# Generate a 500x500 window
...
energy = 10	# Initialize energy to 11
...
while go:
	...
	for event in pygame.event.get():
		if event.type == pygame.MOUSEBUTTONUP:
			applepos = np.array(pygame.mouse.get_pos())
			if not run_game():
				go = False
